...
Gym: **0** hardened · 5 proven · 2 covered · 6 declared. Wiki: **13** documented · 0 undocumented.

**design** 3 caps, 0 hardened, 1 landed reps · **build** 7 caps, 0 hardened, 3 landed reps · **operate** 3 caps, 0 hardened, 1 landed reps
...
| LH-C08 | Produce a runnable notebook / compute artifact through the chosen surface | build | proven | 1/3 | documented | AG-LAK-001, _AG-LAK-002_ |
...
| LH-C14 | Execute against Fabric Spark compute and drive the run to a verified terminal state | operate | proven | 1/4 | documented | AG-LAK-001, _AG-LAK-002_ |
